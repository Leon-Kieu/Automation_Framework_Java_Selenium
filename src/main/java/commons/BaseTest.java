...
public class BaseTest {
	...
	protected WebDriver getBrowserDriver_basic_auth(String browserName, String appUrl, String user, String pass) {
		if (browserName.equals("chrome")) {
			WebDriverManager.chromedriver().setup();
			driver = new ChromeDriver();
		} else if (browserName.equals("h_chrome")) {
		...
		driver.manage().window().maximize();
		driver.get(appUrl);
		driver.get(passusernamePassurl(appUrl, user, pass));
		return driver;
	}
	
	public String passusernamePassurl(String url, String username, String pass) {
		String [] arrayUrl = url.split("//");
		return arrayUrl[0] + "//"+username+":"+pass+"@"+arrayUrl[1];
	}
